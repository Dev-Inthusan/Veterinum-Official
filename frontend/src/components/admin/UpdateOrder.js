...
export default function UpdateOrder () {
    ...
    useEffect(() => {
        if(isOrderUpdated) {
            toast('Booking Updated Succesfully!',{
                type: 'success',
            ...
            <div className="col-12 col-md-10 ">
                ...
                <div className="row d-flex justify-content-around">
                        <div className="col-12 col-lg-8 mt-5 order-details">
                            ...
                            <h1 className="my-5">Booking # {orderDetail._id}</h1>
    
                            <h4 className="mb-4">Appointing Info</h4>
                            ...
                            <p className={orderStatus&&orderStatus.includes('Appointed') ? 'greenColor' : 'redColor' } ><b>{orderStatus}</b></p>
    
    
                            <h4 className="my-4">Booking Info :</h4>
