        ...
        <Fragment>
           <div className="container container-fluid"> 
            ...
            <Fragment>
                ...
                <div className="row f-flex justify-content-around container container-fluid">
                    ...
                    <h3>{product.name}</h3>
                    <p id="product_id">Veterinarian # {product._id}</p>
                    ...
                    <p className="text-bold">Number of Pets</p>
                    ...
                    <button type="button" id="cart_btn" 
                     ...
                     >Add to Appointment</button>

                    <hr/>

                    <p>Service : <span className={product.stock > 0 ?'greenColor':'redColor'} id="stock_status">{ product.stock > 0 ?'In Service':'Out of Service'}</span></p>

                    <hr/>

                    <h4 className="mt-2">Specialization:</h4>
                    <p>{product.description}</p>
                    <hr/>
                    <p id="product_seller mb-3">Located : <strong>{product.seller}</strong></p>
                    { user ?
